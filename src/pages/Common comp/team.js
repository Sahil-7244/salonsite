                ...
                <div className="container-fluid px-md-5">
                    ...
                    <div className="row">
                        <FadeInUp classname="col-md-12 ftco-animate">
                            <OwlCarousel
                            className="carousel-team owl-carousel"
                            autoplay
                            autoHeight
                            items={1}
                            margin= {30}
                            ...
                            responsive={{
                            ...
                            }}>
                                {
                                    teamdata.map(
                                        (team,i)=>{
                                            return <Teamprops key={i} img={team.image} name={team.name} post={team.post} />
                                        }
                                    )
                                }
                            </OwlCarousel>
        ...
        <>
            <div className="item">
                <a href="#" className="team text-center">
                    <div className="img" style={{backgroundImage: "url(images/"+props.img+")"}}></div>
                    <h2>{props.name}</h2>
